...
\begin{solution}
    Part (a): You would be able to tell by the ordered pairs within the set $S$. There cannot be a unique $a$ value such that there are two different $b$ values. This would render it not a function, due to failing the vertical line test.  \\ 
    Part(b): 
\end{solution}
